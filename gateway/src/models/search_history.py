...
class SearchHistory(Base):
    ...
    search_date: Mapped[datetime] = mapped_column(DateTime, nullable=False, server_default=func.now())
    ...
    results = relationship("SearchResults", back_populates="query", passive_deletes=True)
